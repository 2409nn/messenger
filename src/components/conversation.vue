  ...
  <section class="conv" :class="{'active': isChatOpen}" >
    <div class="conv__heading heading" v-if="isChatOpen">
      ...
      <div class="conv__buttons">
        <button class="conv__buttons-button" @click="() => {emit('audioCallClicked', true)}">
        ...
        <button class="conv__buttons-button" @click="() => {emit('videoCallClicked', true)}">
    ...
    <div class="conv__send" v-if="isChatOpen">
      <form class="conv__send__form" >
        ...
        <div class="conv__send__form-buttons">
          ...
          <button type="button" class="conv__send__form-buttons-buttons-button microphone-btn" @click="onMicroClick">
            <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
